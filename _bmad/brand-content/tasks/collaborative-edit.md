# Collaborative Edit - Arcadia Developer Task
...
*collaborative-edit start --component arcadia-core/agents/data-agent.md --participants alice,bob --mode live
...
class CollaborativeEditTask extends EventEmitter {
  constructor() {
    ...
    this.sessionDir = path.join(this.rootPath, '.arcadia', 'sessions');
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('👥 Arcadia Collaborative Editing'));
