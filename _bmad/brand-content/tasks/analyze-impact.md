# Analyze Impact - Arcadia Developer Task

## Purpose
Analyze the potential impact of proposed component modifications on the broader Arcadia framework.
...
*analyze-impact modify arcadia-core/agents/weather-agent.md --depth deep --include-tests

# Analyze deprecation impact with visual output
*analyze-impact deprecate arcadia-core/utils/old-helper.js --output-format visual --save-report reports/deprecation-impact.html

# Quick impact check for refactoring
*analyze-impact refactor arcadia-core/tasks/process-data.md --depth shallow --risk-threshold medium

# Analyze removal with approval workflow
*analyze-impact remove arcadia-core/workflows/legacy-workflow.yaml --depth deep --save-report reports/removal-impact.json
```
...
class AnalyzeImpactTask {
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('🔍 Arcadia Impact Analysis'));
...
{
  "success": true,
  "targetComponent": "arcadia-core/agents/weather-agent.md",
  "riskLevel": "medium",
