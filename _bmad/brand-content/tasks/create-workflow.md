...
## Purpose
To create a new workflow definition that orchestrates multiple agents and tasks for complex multi-step processes in Arcadia.
...
4. **Create Workflow File**
   - Generate path: `.arcadia-core/workflows/{workflow-name}.yaml`
...
📁 Location: .arcadia-core/workflows/{workflow-name}.yaml
📊 Workflow Summary:
   - Stages: {stage-count}
   - Agents: {agent-list}
   - Type: {workflow-type}
