...
- Target agent must exist in `arcadia-core/agents/`
...
- Load target agent from `arcadia-core/agents/{agent-name}.md`
- Parse YAML header and markdown content separately
- Create timestamped backup: `arcadia-core/agents/.backups/{agent-name}.md.{timestamp}`
