# Deprecate Component - Arcadia Developer Task
...
*deprecate-component util old-logger --replacement @arcadia/logger --migration-guide docs/migration/logger.md --severity high
...
class DeprecateComponentTask {
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('🚫 Arcadia Component Deprecation'));
  ...
  async initializeDependencies() {
    try {
      ...
      const DeprecationManager = require('../utils/deprecation-manager');
