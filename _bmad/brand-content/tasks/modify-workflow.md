...
- Target workflow must exist in `arcadia-core/workflows/`
...
- Load target workflow from `arcadia-core/workflows/{workflow-name}.yaml`
- Create timestamped backup: `arcadia-core/workflows/.backups/{workflow-name}.yaml.{timestamp}`
