...
- Target task must exist in `arcadia-core/tasks/`
...
- Load target task from `arcadia-core/tasks/{task-name}.md`
- Create timestamped backup: `arcadia-core/tasks/.backups/{task-name}.md.{timestamp}`
