...
## Purpose
To create a new agent definition file following Arcadia standards using the template system with progressive disclosure elicitation.
...
The elicitation workflow is now handled by `arcadia-core/elicitation/agent-elicitation.js` with:
...
4. **Create File**
   - Generate path: `.arcadia-core/agents/{agent-name}.md`
...
📁 Location: .arcadia-core/agents/{agent-name}.md
📝 Next steps:
